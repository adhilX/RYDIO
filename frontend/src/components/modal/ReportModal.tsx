            ...
            <div>
              ...
              <div className="relative">
                <textarea
                  id="report-reason"
                  rows={5}
                  className={`block w-full rounded-lg border bg-gray-800/50 border-gray-700 p-3 text-white placeholder-gray-500 focus:border-orange-500 focus:ring-orange-500 sm:text-sm resize-none ${
